...
//	}
/**
 * Método que cambia la pantalla después de la animación del splash
 */
	public void showHome() {
		try {
			// Load the fxml file and create a new stage for the popup.
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(Main.class.getResource("entrada.fxml"));
			...
			e.printStackTrace();
			System.out.println("No se ha podido entrar");
		}
	}
/**
 * Método incicializador y realiza las animaciones del splash y llama al método ShowHome
 */
...
//										main.closeStage();
								...
								thisStage.close();
								showHome();
								System.out.println("------- Splash cerrado --------");
							});
